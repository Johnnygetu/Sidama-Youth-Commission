      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-section">
            ...
            <p>
              Representing the voices and interests of all 2.2 million youth in
              Sidama Region.
            </p>
          </div>
          <div className="footer-section">
            <h4>Contact Info</h4>
            <p>
              <i className="fas fa-map-marker-alt"></i> Hawassa, Sidama Region,
              Ethiopia
            </p>
            <p>
            ...
            <p>
              <i className="fas fa-landmark"></i> Ministry of Women & Social
              Affairs
            </p>
          </div>
          <div className="footer-section">
        ...
        <div className="footer-bottom">
          <p>
            &copy; 2025 Sidama Region Youth Council (SRYC). All rights reserved.
          </p>
          <p>
            Affiliated with Ethiopia Youth Council | Supervised by Ministry of
