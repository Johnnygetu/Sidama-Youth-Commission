  ...
  return (
    <div className="news-page">
      ...
      <PageHeader 
        ...
        subtitle="Stay informed about the latest developments, events, and achievements of the Sidama Youth Council. Discover how we're making a difference in our community."
        logoImage={logoImage}
        headerRef={headerRef}
      />
