        ...
        <div className="container">
          ...
          <div className="events-grid">
            {/* Existing 6 events */}
               ...
               <div className="event-header" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=400&h=200&fit=crop)' }}>
                 <div className="event-date">
                   <span className="event-day">20</span>
                   <span className="event-month">Dec</span>
                 </div>
                 <h3 className="event-title">Annual Youth Summit 2024</h3>
                 <div className="event-details">
                   <span className="event-time">9:00 AM - 5:00 PM</span>
                   <span className="event-location">Hawassa Convention Center</span>
                 </div>
               </div>
              <div className="event-content">
                <p>
                  Join us for our annual youth summit where young leaders will discuss important issues 
                  affecting our community and share innovative solutions.
                </p>
                <a href="#" className="btn btn-primary">Register Now</a>
              </div>
            </div>
                         <div className="event-card">
               <div className="event-header" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1542810634-71277d95dcbb?w=400&h=200&fit=crop)' }}>
                 <div className="event-date">
                   <span className="event-day">25</span>
                   <span className="event-month">Dec</span>
                 </div>
                 <h3 className="event-title">Christmas Community Service</h3>
                 <div className="event-details">
                   <span className="event-time">10:00 AM - 2:00 PM</span>
                   <span className="event-location">Various Locations</span>
                 </div>
               </div>
              <div className="event-content">
                <p>
                  Spread joy and hope this Christmas by participating in our community service activities 
                ...
                <a href="#" className="btn btn-primary">Join Us</a>
                         ...
                         <div className="event-card">
               <div className="event-header" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=400&h=200&fit=crop)' }}>
                 <div className="event-date">
                   <span className="event-day">30</span>
                   <span className="event-month">Dec</span>
                 </div>
                 <h3 className="event-title">New Year Planning Workshop</h3>
                 <div className="event-details">
                   <span className="event-time">2:00 PM - 6:00 PM</span>
                   <span className="event-location">Youth Center</span>
                 </div>
               </div>
              <div className="event-content">
                <p>
                  Let's plan for an amazing 2024! Join our workshop to set goals and create action plans 
                ...
                <a href="#" className="btn btn-primary">Sign Up</a>
                         ...
                         <div className="event-card">
               <div className="event-header" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1523240795131-0a3f4bf0e132?w=400&h=200&fit=crop)' }}>
                 <div className="event-date">
                   <span className="event-day">05</span>
                   <span className="event-month">Jan</span>
                 </div>
                 <h3 className="event-title">Career Guidance Seminar</h3>
                 <div className="event-details">
                   <span className="event-time">1:00 PM - 4:00 PM</span>
                   <span className="event-location">University Auditorium</span>
                 </div>
               </div>
              <div className="event-content">
                <p>
                  Get expert advice on career planning, resume building, and interview preparation 
                  from industry professionals and career counselors.
                </p>
                <a href="#" className="btn btn-primary">Register</a>
              </div>
            </div>
                         <div className="event-card">
               <div className="event-header" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&h=200&fit=crop)' }}>
                 <div className="event-date">
                   <span className="event-day">12</span>
                   <span className="event-month">Jan</span>
                 </div>
                 <h3 className="event-title">Entrepreneurship Bootcamp</h3>
                 <div className="event-details">
                   <span className="event-time">9:00 AM - 6:00 PM</span>
                   <span className="event-location">Business Incubator Center</span>
                 </div>
               </div>
              <div className="event-content">
                <p>
                  Learn the fundamentals of starting and running a successful business. 
                  This intensive bootcamp covers business planning, marketing, and financial management.
                </p>
                <a href="#" className="btn btn-primary">Apply Now</a>
              </div>
            </div>
                         <div className="event-card">
               <div className="event-header" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8a?w=400&h=200&fit=crop)' }}>
                 <div className="event-date">
                   <span className="event-day">20</span>
                   <span className="event-month">Jan</span>
                 </div>
                 <h3 className="event-title">Cultural Exchange Program</h3>
                 <div className="event-details">
                   <span className="event-time">3:00 PM - 7:00 PM</span>
                   <span className="event-location">Community Hall</span>
                 </div>
               </div>
              <div className="event-content">
                <p>
                  Celebrate our diverse cultural heritage through music, dance, food, and storytelling. 
                  Connect with youth from different backgrounds and learn about various traditions.
                </p>
                <a href="#" className="btn btn-primary">Join Event</a>
              </div>
            </div>
            {/* 3 more dummy events */}
                         <div className="event-card">
               <div className="event-header" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=200&fit=crop)' }}>
                 <div className="event-date">
                   <span className="event-day">28</span>
                   <span className="event-month">Jan</span>
                 </div>
                 <h3 className="event-title">Public Speaking Workshop</h3>
                 <div className="event-details">
              ...
              <div className="event-content">
                <p>
                  Improve your public speaking and presentation skills with hands-on activities and expert feedback.
                </p>
                <a href="#" className="btn btn-primary">Sign Up</a>
              </div>
            </div>
                         <div className="event-card">
               <div className="event-header" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=400&h=200&fit=crop)' }}>
                 <div className="event-date">
                   <span className="event-day">05</span>
                   <span className="event-month">Feb</span>
                 </div>
                 <h3 className="event-title">Green Initiative Launch</h3>
                 <div className="event-details">
                   <span className="event-time">11:00 AM - 3:00 PM</span>
                   <span className="event-location">Central Park</span>
                 </div>
               </div>
              <div className="event-content">
                <p>
                  Join us as we launch our new environmental sustainability program with tree planting and clean-up activities.
                </p>
                <a href="#" className="btn btn-primary">Volunteer</a>
              </div>
            </div>
                         <div className="event-card">
               <div className="event-header" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=400&h=200&fit=crop)' }}>
                 <div className="event-date">
                   <span className="event-day">15</span>
                   <span className="event-month">Feb</span>
                 </div>
                 <h3 className="event-title">Tech for Good Hackathon</h3>
                 <div className="event-details">
                   <span className="event-time">8:00 AM - 8:00 PM</span>
                   <span className="event-location">Innovation Hub</span>
                 </div>
               </div>
              <div className="event-content">
                <p>
                  Collaborate with fellow youth to build tech solutions for social impact. Prizes for the best projects!
                </p>
                <a href="#" className="btn btn-primary">Register Team</a>
              </div>
            </div>
          </div>
        </div>
